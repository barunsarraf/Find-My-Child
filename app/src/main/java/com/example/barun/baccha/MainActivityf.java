...
import android.content.Context;
        ...
        import com.example.barun.baccha.Postforfound;
...
public class MainActivityf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MainActivityf.this, "Please Wait",Toast.LENGTH_LONG).show();
        mfoundlist=(RecyclerView) findViewById(R.id.lost_list);
        mfoundlist.setHasFixedSize(true);
        mfoundlist.setLayoutManager(new LinearLayoutManager(this));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Dataf,Dataviewholder>
                firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Dataf, Dataviewholder>(

                Dataf.class,R.layout.foundlistrow,
                Dataviewholder.class,
                mDatabase

        ) {
            @Override
            protected void populateViewHolder(final Dataviewholder viewHolder, final Dataf model, final int position) {
                ...
                viewHolder.mview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(MainActivityf.this, "This feature will be implemented soon",Toast.LENGTH_LONG).show();
        ...
        mfoundlist.setAdapter(firebaseRecyclerAdapter);
